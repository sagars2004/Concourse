...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-slate-950 rounded-md z-0",
        className
      )}
    >
      <div className="relative z-0 flex w-full flex-1 scale-y-125 items-center justify-center isolate">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 bg-transparent opacity-10 backdrop-blur-md" />
        <div className="absolute inset-auto h-36 w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-3xl" />
        <motion.div
          initial={{ width: "8rem" }}
